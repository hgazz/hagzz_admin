...
class AcademiesRequest extends FormRequest
{
    ...
    public function onCreate()
    {
        return [
            ...
            'role'=>'required|in:owner,manager,branch_manager,accountant,receptionist,partner',
            ...
            'country_id' => 'required_with:saas_plan_id|nullable|exists:countries,id',
            ...
            'free_months' => 'nullable|integer|min:0|max:60',
            'discount_type' => 'nullable|required_with:discount_value|in:percentage,fixed',
            'discount_value' => 'nullable|numeric|min:0',
            'discount_starts_at' => 'nullable|date|after_or_equal:subscription_starts_at',
            'discount_ends_at' => 'nullable|date|after_or_equal:discount_starts_at',
            'billing_starts_at' => 'nullable|date|after_or_equal:subscription_starts_at',
            'grace_days' => 'nullable|integer|min:0|max:90',
            'billing_notes' => 'nullable|string|max:2000',
            'subscription_status' => 'nullable|in:active,suspended,cancelled',
