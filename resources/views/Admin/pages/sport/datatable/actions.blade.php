    ...
    <div class="btn-group dropstart" role="group">
        ...
        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            ...
            <li class="mb-1">
                ...
                <a class="d-block show_confirm_two text-danger text-center fw-bold" href="javascript:void(0);" data-href="{{ route('admin.sport.delete') }}"  data-id="{{ $sport->id }}" data-name="Sport">
