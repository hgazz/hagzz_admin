...
@section('title', trans('admin.country.country'))
                        ...
                        <div class="page-header">
                            ...
                            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ trans('admin.country.country') }}</li>
                                </ol>
                            </nav>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <a href="{{route('admin.cities.create')}}">
                        <h3>{{ trans('admin.country.country') }}</h3>
                    </a>
                    <a href="{{route('admin.country.create')}}" class="btn btn-primary">
                        {{ trans('admin.country.create') }}
                    </a>
                </div>
