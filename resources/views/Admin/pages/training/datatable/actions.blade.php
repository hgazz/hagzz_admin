...
<div class="btn-sm btn-group" role="group" aria-label="Button group with nested dropdown">
    <div class="btn-group dropstart" role="group">
        ...
        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <form action="{{ route('admin.training.active', $training) }}" method="post" class="d-inline"
                id="updateStatus-{{ $training->id }}">
                @csrf @method('PUT')
            </form>
{{--            <li class="mb-1">--}}
{{--                @if ($training->active)--}}
{{--                    <a href="javascript:void(0)"--}}
{{--                        onclick="document.getElementById('updateStatus-{{ $training->id }}').submit();" type="submit"--}}
{{--                        class="text-success text-center fw-bold" title="{{ $training->active }}">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"--}}
{{--                            class="bi bi-x-square-fill m-2 fw-bold" viewBox="0 0 16 16">--}}
{{--                            <path--}}
...
{{--                    <a href="javascript:void(0)"--}}
{{--                        onclick="document.getElementById('updateStatus-{{ $training->id }}').submit();" type="submit"--}}
{{--                        class="text-danger text-center fw-bold" title="{{ $training->active }}">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"--}}
{{--                            class="bi bi-check2-square m-2 fw-bold" viewBox="0 0 16 16">--}}
{{--                            <path--}}
...
{{--            </li>--}}
            <li class="mb-1">
                ...
                <a href="{{ route('admin.training.createBooking', $training) }}" class="text-success text-center"
                    title="{{ trans('admin.training.booking') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-bookmark-plus m-2 fw-bold" viewBox="0 0 16 16">
                        <path
            ...
            @if ($training->joins->count() == 0)
                <li class="mb-1">
                    <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                    <a class="text-danger text-center fw-bold show_confirm_two" href="javascript:void(0);"
                        data-href="{{ route('admin.trainings.delete') }}" data-id="{{ $training->id }}"
                        data-name="Training">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-trash3-fill m-2 fw-bold" viewBox="0 0 16 16">
                            <path
