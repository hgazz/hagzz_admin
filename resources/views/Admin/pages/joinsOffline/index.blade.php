...
{{--                <a class="btn btn-success w-25 mt-1 mb-2" href="{{route('admin.report.join.export')}}" target="_blank">{{ trans('admin.Export') }}</a>--}}

        <div class="card">
            <div class="card-header">
                <div class="row">
                    <form method="GET" action="{{ route('admin.report.joins-offline-filter') }}">
