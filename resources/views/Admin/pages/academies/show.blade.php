                    ...
                    <div class="col-md-12 ">
                        <div class="card" style="width: 30rem;">
                            <div class="card-body">
                                ...
                                <p class="card-text d-inline">{{$academies->address}}</p>
                                /
                                <p class="card-text d-inline">{{$academies->role}}</p>
                                <br>
                                <span class="card-text">{{$academies->email}}</span> / <span class="card-text">{{$academies->phone}}</span>
                                <br>
                                <span class="card-text">{{$academies->trade_license_number}}</span> / <span class="card-text">{{$academies->trade_license_expire_date}}</span>
                                <br>
                                <span class="card-text">{{$academies->national_id_number}}</span> / <span class="card-text">{{$academies->contract_number}}</span>
                                <br>
