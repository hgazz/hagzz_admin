<div class="header-container container-xxl">
    <header class="header navbar navbar-expand-sm expand-header justify-content-between">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{{ route('admin.index') }}">
                    <img src="{{ asset('assetsAdmin/logo/Lettermark-Primary.svg') }}" width="40px" height="40px"
                        alt="Hagzz">
                </a>
            </li>
        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0 action-area gap-lg-3 gap-md-2 gap-1">

            <li class="nav-item dropdown language-dropdown">
                <a href="javascript:void(0)" class="nav-link dropdown-toggle" id="language-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ app()->getLocale() === 'en' ? asset('assetsAdmin/src/assets/img/1x1/us.svg') : asset('assetsAdmin/src/assets/img/1x1/qa.svg') }}"
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        @if ($properties['native'] === 'English')
                            <a class="dropdown-item d-flex"
                                ...
                                <img src="{{ asset('assetsAdmin/src/assets/img/1x1/us.svg') }}" class="flag-width"
                                    alt="flag">
                                <span class="align-self-center">{{ $properties['native'] }}</span></a>
                        @elseif($properties['native'] === 'العربية')
                            <a class="dropdown-item d-flex"
                                href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                <img src="{{ asset('assetsAdmin/src/assets/img/1x1/qa.svg') }}" class="flag-width"
                                    alt="flag">
                                <span class="align-self-center">{{ $properties['native'] }}</span></a>
                        @endif
                    @endforeach
                ...
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                    ...
                    <div class="avatar-container">
                        <div class="avatar avatar-sm avatar-indicators avatar-online">
                            <img alt="avatar" src="{{ asset('assetsAdmin/logo/Icon-Primary.svg') }}"
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <a href="{{ route('admin.profile.index') }}">
                            ...
                            </svg> <span>{{ trans('admin.profile.profile') }}</span>
                        </a>
                    </div>
                    {{--                    <div class="dropdown-item"> --}}
