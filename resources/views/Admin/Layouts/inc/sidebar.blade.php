    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ Request::routeIs('admin.sport.*') ? 'active' : '' }}">
                <a href="#prefences" data-bs-toggle="collapse" aria-expanded="{{ Request::routeIs('admin.sport.*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{ Request::routeIs('admin.sport.*')  ? 'show' : '' }}" id="prefences" data-bs-parent="#accordionExample">
                    <li class="menu {{ Request::routeIs('admin.sport.*') ? 'active' : '' }}">
