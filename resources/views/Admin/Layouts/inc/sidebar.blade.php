        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ $reportsOpen ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{ $reportsOpen ? 'show' : '' }}" id="report" data-bs-parent="#accordionExample">
                    ...
                    <li class="menu {{ Request::routeIs('admin.report.transactions') ? 'active' : '' }}"><a href="{{ route('admin.report.transactions') }}" class="dropdown-toggle"><div class="admin-menu-label"><x-feather-icon name="repeat" class="admin-menu-icon" /><span>{{ trans('admin.transaction') }}</span></div></a></li>
                    <li class="menu {{ Request::routeIs('admin.report.joins') ? 'active' : '' }}"><a href="{{ route('admin.report.joins') }}" class="dropdown-toggle"><div class="admin-menu-label"><x-feather-icon name="bookmark" class="admin-menu-icon" /><span>{{ trans('admin.bookings.bookings') }}</span></div></a></li>
                    <li class="menu {{ Request::routeIs('admin.report.offline-joins') ? 'active' : '' }}"><a href="{{ route('admin.report.offline-joins') }}" class="dropdown-toggle"><div class="admin-menu-label"><x-feather-icon name="clipboard" class="admin-menu-icon" /><span>{{ trans('admin.bookings.offline_bookings') }}</span></div></a></li>
